...
cf.read(os.path.join(BASE_DIR, "workspace/train_model/modelConfig.ini"), encoding='utf-8')
...
class modelEvaluate:
    ...
    def generationTextPipe(self,
        ...
        if num_return_sequences % 100 > 0:
            allGeneration = generator(prefixList, num_return_sequences=num_return_sequences % 100,
